...
export interface ProjectCreationSimpleVersionSubmittedEvent {
  ...
  properties: {
    ...
    useOrioleDb?: boolean
    /**
     * Whether the tableEditorApiAccessToggle feature flag was enabled for this user,
     ...
     * omitted = feature flags had not loaded at the time of project creation
     */
...
export interface DashboardErrorCreatedEvent {
  ...
  properties: {
    ...
    errorType?: string
    /**
     * Whether inline help steps are available (for error_display source)
     */
    hasInlineHelpSteps?: boolean
  }
  groups: TelemetryGroups
}
...
/**
 * Triggered when a user opens or closes an inline error accordion step.
 *
 * @group Events
 * @source studio
 */
...
export interface InlineErrorTroubleshooterActionClickedEvent {
  ...
  properties: {
    ...
    ctaType: 'restart_db' | 'blog_post' | 'ask_ai' | 'contact_support'
  }
  groups: TelemetryGroups
}
