...
>
    ...
    - **Optional**: programmatically exchange an access token for project API keys via the [Management API](https://supabase.com/docs/reference/api/management-projects-api-keys-retrieve).
